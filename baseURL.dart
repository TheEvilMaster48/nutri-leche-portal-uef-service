class Base {
  ...
  //final String BASE_URL="http://192.168.18.41:8080/nutrisoft/rest/";
  //final String BASE_URL = "http://192.170.4.60:8080/nutrisoft/rest/";
  ...
  final Color COLOR_GRIS = Utils().colorFromHex("#EBEEF0");
 
  // GoogleFonts.montserrat().fontFamily), por defectoo
    /*
    final String BASE_URL_CONSULTAS_POSTMAN =
